module open-cluster-management.io/ocm-virtual-workspace
...
require (
	...
	open-cluster-management.io/api v0.7.1-0.20220601020523-fa4065643d84
)
...
require (
	...
	github.com/kcp-dev/kcp v0.4.0-alpha.0.0.20220530172228-61610542fc6e
...
replace open-cluster-management.io/api => github.com/elgnay/ocm-api v0.0.0-20220602035849-1a1c401fc602
