...
import (
	...
	"open-cluster-management.io/ocm-virtual-workspace/pkg/manifestwork/builder"
)

type ManifestWorks struct{}

func NewManifestWorks() *ManifestWorks {
	return &ManifestWorks{}
}

func (o *ManifestWorks) AddFlags(flags *pflag.FlagSet, prefix string) {
	if o == nil {
		return
	}
}

func (o *ManifestWorks) Validate(flagPrefix string) []error {
	if o == nil {
		return nil
	}
	errs := []error{}
...
func (o *ManifestWorks) NewVirtualWorkspaces(
...
func (o *ManifestWorks) Name() string {
	return "workspaces"
}
